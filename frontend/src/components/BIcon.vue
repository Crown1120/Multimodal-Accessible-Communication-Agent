...
const ICONS: Record<string, string> = {
  ...
  // 场景
  hospital: '<path d="M12 3v18M3 12h18"/><rect x="5" y="5" width="14" height="14" rx="2"/>',
  government:
    '<path d="M3 21h18"/><path d="M5 21V8l7-5 7 5v13"/><path d="M9 21v-6h6v6"/><path d="M9 12h.01M15 12h.01"/>',
  // 连接状态
  ...
  ear: '<path d="M6 8.5a6 6 0 0 1 12 0c0 3-2.5 3.5-3.5 5-.8 1.2-.5 3.5-.5 3.5"/><path d="M10 20a2 2 0 0 0 4 0"/>',
  ...
  // 字幕
  captions:
    '<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M6 11c1-1.5 3-1.5 4 0M14 11c1-1.5 3-1.5 4 0M6 15c1-1.5 3-1.5 4 0M14 15c1-1.5 3-1.5 4 0"/>',
  // Widget
